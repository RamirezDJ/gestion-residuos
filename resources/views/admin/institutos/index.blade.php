                        ...
                        <div class="bg-white shadow rounded-lg p-6">
                            <div class="flex flex-col items-center">
                                ...
                                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                                    ...
                                    {{-- <a href="#"
                                            class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded">Crear</a> --}}
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col mb-4">
                                <span class="text-gray-700 uppercase font-bold tracking-wider mb-2">Fecha de
                                    creación</span>
                                <p>
                                    {{ $instituto->created_at }}
                                </p>
                            </div>
                            <div class="flex flex-col">
                                <span class="text-gray-700 uppercase font-bold tracking-wider mb-2">Encargado</span>
                                <p> {{ Auth::user()->name }} </p>
                            </div>
                        ...
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            @else
                                <div class="p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:text-blue-400"
                                    role="alert">
                                    <span class="font-medium">Alerta descripcion!</span> Para quitar esta alerta, ingrese una descripcion de su universidad.
                                </div>
                            @endif


                            <h2 class="text-xl font-bold mt-6 mb-4">Información</h2>
                            <div class="mb-6">
                                <div class="flex justify-between flex-wrap gap-2 w-full">
                                    <span class="text-gray-700 font-bold">Dirección</span>
                                    {{-- <p>
                                ...
                                @else
                                    <div class="p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:text-blue-400"
                                        role="alert">
                                        <span class="font-medium">Alerta direccion!</span> Para quitar esta alerta
                                        ingrese la direccion de su universidad.
                                    </div>
                                @endif
                            </div>
                            <div class="mb-6">
                                <div class="flex justify-between flex-wrap gap-2 w-full mb-4">
                                    <span class="text-gray-700 font-bold">Contacto</span>
                                    {{-- <p>
                                        <span class="text-gray-700 mr-2">at ABC Company</span>
                                        <span class="text-gray-700">2017 - 2019</span>
                                    </p> --}}
                                </div>
                                @if ($instituto->telefono || $instituto->email || $instituto->sitio_web != null)
                                    <p class="mt-2">
                                        {{ $instituto->telefono }}
                                        <br>
                                        {{ $instituto->email }}
                                ...
                                @else
                                    <div class="p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:text-blue-400"
                                        role="alert">
                                        <span class="font-medium">Alerta Contacto!</span> Para quitar esta alerta
                                        ingrese un medio de contacto de su universidad.
                                    </div>
                                @endif
                            </div>
                            <div class="mb-6">
                                ...
                                @if ($instituto->meta_anual != null)
                                    <p class="mt-2">
                                        {{ $instituto->meta_anual }}
                                    </p>
                                @else
                                    <div class="p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:text-blue-400"
                                        role="alert">
            ...
            @else
                <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                    <div class="col-span-4 sm:col-span-3 2xl:col-span-2">
                        <div class="bg-white shadow rounded-lg p-6">
                            <div class="flex flex-col items-center">
                                <h1 class="text-lg text-center font-bold">Registrar una universidad</h1>
                                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                                    <a class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-md text-sm px-5 py-2.5 me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                                        href="{{ route('admin.institutos.create') }}">Crear nuevo</a>
                                    {{-- <a href="#"
                                        class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded">Crear</a> --}}
                                </div>
                            </div>
                    ...
                    <div class="col-span-4 sm:col-span-9 2xl:col-span-10">
                        <div class="bg-white shadow rounded-lg p-6">
                            <div class="p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:text-blue-400"
                                role="alert">
                                <span class="font-medium">Alerta!</span> Para empezar es necesario crear una
                                universidad y registrar los datos necesarios
                            </div>
                        </div>
                    </div>
