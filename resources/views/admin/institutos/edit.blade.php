<x-admin-layout :breadcrumb="[
    ...
    <div class="bg-gray-100">
        <div class="container mx-auto py-8 xl:max-w-full">
            <form action="{{ route('admin.institutos.update', $instituto) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-col items-center">
                                <figure>
                                    <img class="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0"
                                        src="{{ $instituto->image ?? asset('src/images/placeholder.jpg') }}"
                                        alt="Logo del Instituto" id="imgPreview">
                                </figure>
                                ...
                                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                                    ...
                                    {{-- <a href="#"
                                        class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded">Actualizar</a> --}}
                                    <x-button>
                                        Actualizar datos
                                    </x-button>
                                </div>
                        ...
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <x-input class="w-full" name="telefono" placeholder="Ingrese el telefono"
                                    value="{{ old('telefono', $instituto->telefono) }}" />
                            </div>
                            <div class="mb-4">
                                <x-label class="mb-1">
                                    Correo electronico
                                ...
                                <div class="relative">
                                    ...
                                    <x-input type="email" class="block w-full ps-10 p-2.5 " name="email"
                                        placeholder="name@name.com" value="{{ old('email', $instituto->email) }}" />
                                </div>
                            </div>
                            <div class="mb-4">
                                <x-label class="mb-1">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input class="block w-full ps-10 p-2.5 " name="sitio_web"
                                        placeholder="tecnm.com.mx"
                                        value="{{ old('sitio_web', $instituto->sitio_web) }}" />
                                </div>
                            </div>
                            <div class="mb-4">
                                <x-label class="mb-1">
                                ...
                                <x-input type="number" step="0.01" class="w-full" name="meta_anual"
                                    placeholder="Ingrese la meta anual de la universidad"
                                    value="{{ old('meta_anual', $instituto->meta_anual) }}" />
                            </div>
