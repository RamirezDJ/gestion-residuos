<x-app-layout>
    <div
        ...
        <div class="bg-white rounded-lg p-10 shadow">
            ...
            <form action="{{ route('evidenciasGenerado.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6 relative">
                    <figure>
                        <img class="aspect-[3/1] object-cover object-center w-full rounded-lg"
                            src="{{ $evidenciaGenerado->url_image ?? asset('src/images/noImage.jpg') }}"
                            alt="evidenciaFormato" id="imgPreview">
                    </figure>
