...
<body>
    <div class="container">
        <div class="header">
            {{-- <img class="logo" src="{{ asset('src/images/itsvalogo.png') }}" alt="itsvalogo"> --}}
        ...
        <div class="section">
            ...
            <table class="data-grid">
                ...
                <tr>
                    <td class="data-label">Turno:</td>
                    <td>{{ $turno }}</td>
                </tr>
                <tr>
                    <td class="data-label">Total generado de todas la zonas:</td>
                    <td class="highlight">
                        @php
        ...
        <div class="section">
            ...
            @foreach ($registros as $zona => $datos)
                <table class="subproduct-table">
                    <thead>
                        <tr>
                            <th colspan="7">{{ $datos->first()->zona }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- Fila de Areas -->
                        @php
                            $areaChunks = array_chunk($datos->pluck('areaAsignada')->toArray(), 6);
