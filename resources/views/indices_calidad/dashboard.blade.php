            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <p class="mt-6 text-gray-500 leading-relaxed">
                        ...
                        registrando parámetros físicos, químicos y biológicos para asegurar el cumplimiento de las
                        normativas
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                Ingresa al formulario para capturar los datos de Conductividad, Turbidez, Temperatura,
                                Color, Olor, Sabor y Sólidos.
                            </p>
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                Ingresa al formulario para capturar los niveles de pH, Oxígeno, Nitratos, Nitritos,
                                Fosfatos, Cloro y Demanda Química (DQO/DBO).
                            </p>
                        ...
                        <div>
                            <div class="flex items-center">
                                <h2 class="text-xl font-semibold text-gray-900">
                                    <p>Parámetros Biológicos</p>
                                </h2>
                            </div>

                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                Ingresa al formulario para capturar el conteo de Coliformes Totales y Coliformes Fecales.
                            </p>
