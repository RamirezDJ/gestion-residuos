<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Nuevo Registro de Parámetros Químicos') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        <h1 class="text-2xl font-medium text-gray-900">Captura de Datos Químicos</h1>
                        <p class="text-gray-500 mt-1">
                            Completa la información de la bitácora. Estás registrando:
                            <span class="font-bold text-green-600">PARÁMETROS QUÍMICOS</span>
                        </p>
                    </div>
