<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8">
                    ...
                    <div class="mb-6 border-b border-gray-200 pb-4">
                        <h3 class="text-lg font-bold text-gray-700">Editar Registro del Día</h3>
                        <p class="text-sm text-gray-500">
                            Modifica los valores de visitantes, trabajadores o residuos para recalcular el per cápita.
                        </p>
                    </div>

                    <form action="{{ route('metaAnual.percapita.update', $registro->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="fecha" datepicker datepicker-autohide datepicker-format="yyyy-mm-dd"
                                        ...
                                        value="{{ old('fecha', \Carbon\Carbon::parse($registro->fecha)->format('Y-m-d')) }}"
                                        required>
                                </div>
                                @error('fecha')
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="visitantes" id="visitantes" required min="0"
                                        ...
                                        value="{{ old('visitantes', $registro->visitantes) }}"
                                        oninput="calcularVistaPrevia()">
                                </div>
                                @error('visitantes')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="trabajadores" id="trabajadores" required min="0"
                                        placeholder="Ej: 45"
                                        class="pl-10 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                        value="{{ old('trabajadores', $registro->trabajadores) }}"
                                        oninput="calcularVistaPrevia()">
                                </div>
                                @error('trabajadores')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="kilos" id="kilos" required min="0"
                                        ...
                                        value="{{ old('kilos', $registro->kilos_residuos) }}"
                                        oninput="calcularVistaPrevia()">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <span class="text-gray-500 sm:text-sm">kg</span>
                                    </div>
                                </div>
                                <p class="text-xs text-gray-500 mt-1">Modifique el peso total si es necesario.</p>
                                @error('kilos')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div
                                class="col-span-1 md:col-span-2 mt-2 p-4 bg-yellow-50 rounded border border-yellow-200">
                                <p class="text-sm font-bold text-yellow-800">Nueva Vista Previa:</p>
                                <div class="flex justify-between items-center mt-2">
                                    <span class="text-sm text-gray-600">Total Personas: <span id="preview-personas"
                                            class="font-bold text-black">0</span></span>
                                    <span class="text-lg text-blue-700 font-bold">Per Cápita: <span
                                            id="preview-resultado">0.0000</span> kg</span>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-end mt-8 pt-4 border-t border-gray-100">
                            <a href="{{ route('metaAnual.percapita.index') }}"
    ...
    <script>
        function calcularVistaPrevia() {
            ...
            document.getElementById('preview-resultado').innerText = perCapita.toFixed(4);
        }
