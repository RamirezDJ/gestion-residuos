                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                        ...
                        <tbody class="text-center">
                            @foreach ($registroPeriodo as $index => $registro)
                                <tr class="border-b dark:border-gray-900">
                                    <th scope="row"
                                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $index + 1 }}
                                    </th>
                                    <td class="px-4 py-3">{{ $registro->fecha_inicio }}</td>
                                    <td class="px-4 py-3">{{ $registro->fecha_final }}</td>
                                    <td class="px-4 py-3">{{ $registro->total_kg }}</td>
                                    <td class="px-4 py-3 flex items-center justify-center gap-2">
                                            ...
                                            <a href="{{route('gensubproductos.showAll', ['instituto_id' => $registro->instituto_id, 'inicio' => $registro->fecha_inicio, 'final' => $registro->fecha_final])}}"><i class="fa-solid fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
